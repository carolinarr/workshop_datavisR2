...
plot_dumbbell_2aUpgrade_i <- d_avglen |> 
  ...
  labs(
    x = "Tooth Length \n(mm?)",
    y = "Dose of \nVitamin C \n(mg/day)",
    title = "Natural supplements of Vitamin C don't always provide more teeth growth than artificial supplements of Vitamin C.",
    subtitle = "Natural supplements correspond to more teeth growth when taken at 0.5 and 1 mg/day, but artifical supplements match natural teeth growth when taken at 2 mg/day.",
    caption = "",
...
plot_dumbbell_2aUpgrade_iii <- plot_dumbbell_2aUpgrade_i +
  theme_minimal() +
  theme(
...
plot_dumbbell_2aUpgrade_iii <- d_avglen |> 
  ggplot(aes(x = len_avg, y = as.factor(dose))) +
  geom_line() + 
  geom_point(
    aes(color = supp),
