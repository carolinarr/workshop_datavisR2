...
In Files pane, let's navigate to our scratch folder:\
**/scratch/network/\<insert-your-netid\>/workshop_datavisR2**
...
mytheme_base <- readRDS('code/mytheme_base.rds')
...
plot_dumbbell_2aUpgrade_iii <- d_avg_len |> 
  ggplot(aes(x = len_avg, y = as.factor(dose))) +
  geom_line() + 
  geom_point(
    aes(color = supp),
