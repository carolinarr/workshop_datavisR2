...
# import your theme
mytheme_base <- readRDS('workshop_datavisR2/code/themes/mytheme_base.rds')
...
ggsave("workshop_datavisR2/plots/dumbbell_vitC_toothgrowth2.png", 
...
1.  This only works for individual images produced with ggplot2 and patchwork.
...
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| Package                                                                                | Function(s)               | ggsave compat. | alignment | comments                                                                          |
+========================================================================================+===========================+================+===========+===================================================================================+
| grid                                                                                   | `viewport`, `grid.layout` | no             | no        | \- [overview](https://bookdown.org/rdpeng/RProgDA/the-grid-package.html)\         |
|                                                                                        |                           |                |           | - more technical                                                                  |
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| [gridExtra](https://cran.r-project.org/package=gridExtra)                              | `grid.arrange`            | yes            | no        | \- axes not aligned                                                               |
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| [(r cookbook)](http://www.cookbook-r.com/Graphs/Multiple_graphs_on_one_page_(ggplot2)) | `multiplot`               | no             | no        |                                                                                   |
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| [gtable](https://cran.r-project.org/package=gtable)                                    | `rbind`, `cbind`          | yes            | yes       |                                                                                   |
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| [cowplot](https://cran.r-project.org/package=cowplot)                                  | `plot_grid`               | yes\*          | yes\*     | \- can remove common y-axis                                                       |
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| [multipanelfigure](https://cran.r-project.org/package=multipanelfigure)                | `multi_panel_figure`      | yes            | yes       |                                                                                   |
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| [ggpubr](https://CRAN.R-project.org/package=ggpubr)                                    | `ggarrange`               |                |           | \- easy creation of a common legend                                               |
|                                                                                        |                           |                |           |                                                                                   |
|                                                                                        |                           |                |           | \- multi-page layouts                                                             |
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| [egg](https://cran.r-project.org/package=egg)                                          | `ggarrange`               | yes            | yes       | \-[overview](https://cran.r-project.org/web/packages/egg/vignettes/Overview.html) |
+----------------------------------------------------------------------------------------+---------------------------+----------------+-----------+-----------------------------------------------------------------------------------+
| [patchwork](https://github.com/thomasp85/patchwork)                                    | `plot_layout`             | yes            | yes       | \- most intuitive?\                                                               |
|                                                                                        |                           |                |           | - "/" top/bottom\                                                                 |
|                                                                                        |                           |                |           | "\|" side-by-side                                                                 |
|                                                                                        |                           |                |           |                                                                                   |
|                                                                                        |                           |                |           | \- add empty space                                                                |
...
*The table is copied from* <https://cran.r-project.org/web/packages/egg/vignettes/Ecosystem.html> *with a few additions from blog post* <https://adiradaniel.netlify.app/post/ggmultipane/>.

May be able to use ragg package to save?

The drawback here is that you again have to deal with size/resolution issues with images, and if you were using camcorder, now re-jigger each plot to fit into that specific multi-plot layout.
